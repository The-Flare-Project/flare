...
int main(int argc, char *argv[])
{
	...
	const char *args1[] = { "/bin/snake.fapp" };
	const char *args2[] = { "/bin/clock.fapp", "08:40" };
	const char *args3[] = { "/bin/shell.fapp" };
	const char *args4[] = { "/bin/mandelbrot.fapp" };


	int padding = 4;
	program programs[] = {
			{ .w = 55 , .h = 25 , .exec = "bin/clock.fapp", .args = args2, .argc = 2 },
			{ .w = 500, .h = 400, .exec = "bin/shell.fapp", .args = args3, .argc = 3 },
			{ .w = 200, .h = 200, .exec = "bin/snake.fapp", .args = args1, .argc = 1 },
			{ .w = 400, .h = 400, .exec = "bin/mandelbrot.fapp", .args = args4, .argc = 1 }
	};
